...
object DeletedMessageDetector {
    ...
    private val DELETED_PATTERNS = listOf(
        // English (WhatsApp, Messenger, Instagram, Telegram, IMO)
        Pattern.compile("^(?:.+?[:：]\\s+)?(?:This message was deleted|You deleted this message|This message was deleted by (?:the author|an admin|admin|you)|(?:.+?\\s+)?unsent a message|Message was unsent|Message was deleted|Message deleted|Message was removed|This media was deleted|This photo was deleted|This video was deleted|Deleted message|Deleted photo|Deleted video|This message has been deleted|This chat was deleted|\\d+\\s+deleted\\s+messages?)[.!]?$", Pattern.CASE_INSENSITIVE),

        // Bengali (WhatsApp, Messenger, IMO, Telegram) - handles both \u09DF and \u09AF\u09BC
        Pattern.compile("^(?:.+?[:：]\\s+)?(?:(?:এই\\s+)?(?:বার্তাটি|মেসেজটি|বার্তা|মেসেজ|লেখাটি)\\s+(?:মুছে ফেলা হয়েছে|মুছে ফেলা হয়েছে|মুছে দেওয়া হয়েছে|মুছে দেয়া হয়েছে|মুছে ফেলেছেন|মুছে দিয়েছেন|মুছে দিয়েছেন)|(?:.+?\\s+)?(?:একটি\\s+)?(?:বার্তা|মেসেজ)\\s+(?:মুছে ফেলা হয়েছে|মুছে ফেলা হয়েছে|মুছে ফেলেছেন|মুছে দিয়েছেন|মুছে দিয়েছেন)|আপনি\\s+(?:একটি\\s+)?(?:বার্তা|মেসেজ)\\s+(?:মুছে ফেলেছেন|মুছে দিয়েছেন|মুছে দিয়েছেন)|(?:বার্তা|মেসেজ)\\s+মুছে ফেলা হয়েছে|(?:বার্তা|মেসেজ)\\s+মুছে ফেলা হয়েছে|মুছে ফেলা হয়েছে|মুছে ফেলা হয়েছে|মুছে দেওয়া হয়েছে|মুছে দেয়া হয়েছে|মুছে ফেলেছেন|মুছে দিয়েছেন|মুছে দিয়েছেন)[.!]?$", Pattern.CASE_INSENSITIVE),

        // Hindi
        Pattern.compile("^(?:.+?[:：]\\s+)?(?:(?:यह\\s+)?संदेश हटा दिया गया(?: था)?|आपने एक संदेश हटा दिया|(?:.+?\\s+)?ने एक संदेश वापस ले लिया|एक संदेश वापस ले लिया|यह संदेश लेखक द्वारा हटा दिया गया(?: था)?|संदेश हटा दिया गया)[.!]?$", Pattern.CASE_INSENSITIVE),
    ...
    private val UNSENT_AUTHOR_PATTERNS = listOf(
        ...
        // Bengali
        Pattern.compile("^(?:(.+?)\\s+(?:একটি\\s+)?(?:বার্তা|মেসেজ)\\s+(?:মুছে ফেলেছেন|মুছে দিয়েছেন|মুছে দিয়েছেন))[.!]?$", Pattern.CASE_INSENSITIVE),
        // French
